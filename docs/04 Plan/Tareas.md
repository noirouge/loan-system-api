...
| 39 | POST crear préstamo con desembolso: préstamo + asiento + caja en una transacción, validando efectivo | Bloqueada (P-14, P-15) | No | N/A |
| 40 | GET listar préstamos con saldo | Pendiente | No | N/A |
| 41 | GET préstamo por id con saldo y asientos | Pendiente | No | N/A |
| 42 | POST pago con cascada (interés → capital), `SELECT ... FOR UPDATE` y entrada de caja | Bloqueada (P-10) | No | N/A |
