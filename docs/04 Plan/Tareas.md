...
| 112 | Rechazar montos con más de 2 decimales en los POST de caja: Postgres los redondearía solo, con otra regla que D-043 (modifica #6, #8, #9) | Pendiente | No | N/A |
...
| 45 | POST reversión de asiento de préstamo y de su caja (`loan_entry_id` = asiento nuevo) | Completada | No | N/A |
...
| # | Tarea | Estado | ¿Modificada? | Modificada por |
|---:|---|---|---|---:|
| 53 | Cálculo del cargo: tasa × (capital + interés pendiente) | Pendiente | No | N/A |
...
| # | Tarea | Estado | ¿Modificada? | Modificada por |
|---:|---|---|---|---:|
| 60 | Instalar `Microsoft.AspNetCore.Authentication.JwtBearer` 8.0.x | Pendiente | No | N/A |
...
| 65 | POST `api/auth/logout` | Pendiente | No | N/A |
...
| 103 | Helper de pruebas para autenticarse y obtener un JWT | Pendiente | No | N/A |
| 104 | Pruebas de sesión: login, refresh con rotación, reúso que revoca todas las sesiones, logout | Pendiente | No | N/A |
